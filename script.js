...
async function onSuccess(position) {
    ...
    const api_key = "db2534d83c004dc68ff01df25fd97b93";
    ...
    let html = `
            ...
            <div class="col-8">
                ...
                <div class="row">
                    ...
                    <div class="col-8">${(data.population / 1000000).toFixed(1)} Mn</div>
                </div>
                <div class="row">
    ...
    for (const country of data) {
        html += `
            <div class="col-2 mt-2">
                <div class="card" onclick="getCountry('${country.name.common}')">
